#!/usr/bin/python
# $Id: g2sur.py 222 2008-09-15 11:59:34Z tjansson $
"""\
Graphical interface for gggg
Thomas R. N. Jansson
tjansson@fys.ku.dk
"""
...
## Constants
programname = "G2GMT - Conversion of GRAVSOFT grids to GMT format"
version = "0.5"
jobfile = "g2gmt.inp"
logfile = "g2gmt.log"
execute = "g2gmt"
...
######################################################
       ...
       # mainLabel = geomodule.mainline(frame, programname, version)
        ...
        "normal", "Name of gmt  grid to hold result:" , "result.gmt",
        "nohelp")
