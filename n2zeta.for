      program ntozeta    
c $Id: n2zeta.for 273 2009-02-13 14:49:55Z cct $
...
c
     ...
     *obs(10),d0,dg,ba,corr,scor,sscor,sd,ssd,so,sso
...
c anomaly in mgal.
 10   read(12,*,end=99)i,rlat,rlon,h,(obs(k),k=1,n)
     ...
     * write(*,*)' WARNING  out of sequence '
      ...
      write(*,100)i,rlat,rlon,h,dg,ba,corr
      write(14,100)i,rlat,rlon,h,corr
      end if
