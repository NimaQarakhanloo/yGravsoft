...
class liste:
    def __init__(self, Iframe, Ilineposition, Iquestion, Ichoices):
        ...
        self.listLabel.grid(row=Ilineposition, column=0,
...
class NewEntry:
    ...
    def __init__(self, Iframe, Iroot, Irow,
        ...
        self.descrip = Idescrip
        self.root = Iroot
        self.textentry = Entry(Iframe, width=Iwidth,
                               state=Istate, textvariable=self.text)
...
class FileSelector:
    ...
    def __init__(self, Iframe, Iroot, Irow,
        ...
        self.label.grid(row=Irow, column=0, sticky=W)
        self.textentry.grid(row=Irow, column=1, sticky=W, columnspan=2)
        self.browse = Button(Iframe, text="Browse",
                             command=self.showfilebrowser)
...
class FileSelectorSave:
    ...
    def __init__(self, Iframe, Iroot, Irow,
        ...
        self.label.grid(row=Irow, column=0, sticky=W)
        self.textentry.grid(row=Irow, column=1, sticky=W, columnspan=2)
        self.browse = Button(Iframe, text="Save as",
                             command=self.showfilebrowser)
        self.browse.grid(row=Irow, column=3, sticky=E)
